...
namespace KWZP2022
{
    public partial class ParametrProduktForm : Form
    {
        KWZPEntities db;
        public ParametrProduktForm(KWZPEntities db)
        {
            InitializeComponent();
            this.db = db;
        ...
        private void initDataGridViewProduktParametr()
        {
            ...
            dgvvParametrProdukt.Columns["ID_rodzaj_parametr"].Visible = false;
            dgvvParametrProdukt.Columns["ID_jednostka"].Visible = false;            
