...
Nazwa_produktu NVarchar(25) NOT NULL,
Cena_produktu Money NOT NULL
);
CREATE TABLE Dokumentacja(
ID_dokumentacja INT PRIMARY KEY NOT NULL,
ID_produkt INT FOREIGN KEY REFERENCES PT_Produkt(ID_produkt) NOT NULL,
Data Date NOT NULL
);
CREATE TABLE Zamowienie_dokumentacja(
ID_zamowienie INT FOREIGN KEY 
	REFERENCES Dokumentacja(ID_dokumentacja) NOT NULL,
ID_dokumentacja INT FOREIGN KEY 
	REFERENCES Dokumentacja(ID_dokumentacja) NOT NULL,
);

CREATE TABLE PT_Parametr_produkt(
ID_parametr INT PRIMARY KEY NOT NULL,
Nazwa NVarchar(50)NOT NULL,
...
CREATE TABLE PT_Szczegoly_produkt(
ID_produkt INT FOREIGN KEY REFERENCES PT_Produkt(ID_produkt) NOT NULL,
ID_parametr INT FOREIGN KEY REFERENCES PT_Parametr_produkt(ID_parametr) NOT NULL
);

CREATE TABLE PT_Slownik_polprodukt(
ID_polprodukt INT PRIMARY KEY NOT NULL,
Nazwa NVarchar(25) NOT NULL
);

CREATE TABLE PT_Sklad_produkt(
ID_produkt INT FOREIGN KEY REFERENCES PT_Produkt(ID_produkt) NOT NULL,
ID_polprodukt INT FOREIGN KEY REFERENCES PT_Slownik_polprodukt(ID_polprodukt) NOT NULL,
Ilosc INT NOT NULL
);
CREATE TABLE PT_polprodukt(
ID_polprodukt INT PRIMARY KEY NOT NULL,
Nazwa NVarchar(50) NOT NULL,
)
CREATE TABLE PT_Sklad_polprdukt(
ID_polprodukt INT FOREIGN KEY REFERENCES PT_polprodukt(ID_polprodukt) NOT NULL,
ID_material INT NOT NULL,
Masa INT NOT NULL
);

CREATE TABLE PT_Parametr_polprodukt(
ID_parametr INT PRIMARY KEY NOT NULL,
Nazwa NVarchar(50) NOT NULL,
Wartosc_dolna INT NOT NULL,
Nominal INT NOT NULL,
...
CREATE TABLE PT_Szczegoly_polprodukt(
ID_polprodukt INT  FOREIGN KEY REFERENCES PT_polprodukt(ID_polprodukt) NOT NULL,
ID_parametr INT FOREIGN KEY REFERENCES PT_Parametr_polprodukt(ID_parametr) NOT NULL
CONSTRAINT PT_SzczegolyPP PRIMARY KEY (ID_polprodukt, ID_parametr)
);

CREATE TABLE PT_Slownik_stanowisko(
ID_nazwa_stanowiska INT PRIMARY KEY NOT NULL,
Nazwa_stanowiska NVarchar(20) NOT NULL
);

CREATE TABLE PT_Stanowisko_produkcyjne(
ID_stanowisko_produkcyjne INT PRIMARY KEY NOT NULL,
ID_maszyny INT NOT NULL,
ID_nazwa_stanowiska INT FOREIGN KEY REFERENCES PT_Slownik_stanowisko(ID_nazwa_stanowiska) NOT NULL
);

CREATE TABLE PT_Czynnosc_produkcyjna(
ID_czynnosc_produkcyjna INT PRIMARY KEY NOT NULL,
Nazwa NVarchar(50) NOT NULL
);

CREATE TABLE PT_Sklad_stanowisko_produkcyjne(
ID_stanowisko_produkcyjne INT FOREIGN KEY REFERENCES PT_Stanowisko_produkcyjne(ID_stanowisko_produkcyjne) NOT NULL,
ID_narzedzia INT NOT NULL
);

CREATE TABLE PT_Sklad_stanowisko_produkcyjne_maszyny(
ID_stanowisko_produkcyjne INT FOREIGN KEY REFERENCES PT_Stanowisko_produkcyjne(ID_stanowisko_produkcyjne) NOT NULL,
ID_maszyny INT NOT NULL
);


CREATE TABLE PT_Etap_produkcji(
ID_etap_produkcji INT PRIMARY KEY NOT NULL,
ID_stanowisko_produkcyjne INT FOREIGN KEY REFERENCES PT_stanowisko_produkcyjne(ID_stanowisko_produkcyjne) NOT NULL,
ID_czynnosc_produkcyjna INT FOREIGN KEY REFERENCES PT_Czynnosc_produkcyjna(ID_czynnosc_produkcyjna) NOT NULL
);

CREATE TABLE Etap_proces_technologiczny(
ID_etap_proces_technologiczny INT PRIMARY KEY NOT NULL,
ID_pracownik INT NOT NULL,
ID_etap_produkcji INT FOREIGN KEY REFERENCES PT_Etap_produkcji(ID_etap_produkcji) NOT NULL,
Czas_od Date NOT NULL,
Czas_do Date
);

CREATE TABLE PP_proces_technologiczny(
ID_etap_proces_technologiczny INT FOREIGN KEY REFERENCES Etap_proces_technologiczny(ID_etap_proces_technologiczny) NOT NULL,
ID_polprodukt INT FOREIGN KEY 
	REFERENCES PT_polprodukt(ID_polprodukt),
);