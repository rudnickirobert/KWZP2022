...
ID_wytwarzanie INT PRIMARY KEY,
ID_pracownik INT FOREIGN KEY 
	REFERENCES Pracownicy(ID_pracownik) NOT NULL,
Czas_od DATETIME NOT NULL,
Czas_do DATETIME,
...
ID_wytwarzanie INT FOREIGN KEY REFERENCES Wytwarzanie(ID_wytwarzanie) NOT NULL,
ID_proces_polprodukt INT FOREIGN KEY REFERENCES Proces_polprodukt_czynnosc(ID_proces_polprodukt) NOT NULL,
);
CREATE TABLE Proces_wytwarzanie_produkt (
ID_wytwarzanie INT FOREIGN KEY REFERENCES Wytwarzanie(ID_wytwarzanie) NOT NULL,
ID_proces_produkt INT FOREIGN KEY REFERENCES Proces_produkt_czynnosc(ID_proces_produkt) NOT NULL,
);
